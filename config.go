...
import (
	...
	"github.com/coinsec/dnsseeder/version"
...
func loadConfig() (*ConfigFlags, error) {
	...
	// support this special network in coinsec.
	if activeConfig.NetSuffix != 0 {
		...
		activeConfig.NetParams().DefaultPort = "17211"
		activeConfig.NetParams().Name = "coinsec-testnet-10"
	}
